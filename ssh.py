...
class Connection(object):
    ...
    def __init__(self,
        ...
        paramiko.util.log_to_file(templog, level=logging.WARN)
...
def usage():
    print('Usage:')
    print(
        'ssh.py -u [username] -p [password] -h [hostname] --key [key_filename] [local_filename] [remote_filename]')
    print('')
    exit()
...
def main():
    ...
    con = Connection(host=hostname, username=username,
                     password=password, private_key=keyfile)
